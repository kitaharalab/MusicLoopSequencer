...
export default function onMusicLoop(partId, musicLoopId) {
    const url = "http://127.0.0.1:5000/parts/" + String(partId) + "/musicloops/" + String(musicLoopId) + "/wav";

    return axios.get(url, { responseType: 'blob', })       //サーバーから音素材の配列を受け取った後，then部分を実行する．
